    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.vehicleType === 'Car') {
          // create a car
          this.createCar();
        } else if (answers.wehileType === 'Truck') {
          this.createTruck();
      ...
      .prompt([
        {
          ...
          choices: this.vehicles.filter(v => v.vin !== truck.vin).map((vehicle) => {
            return {
              name: `${vehicle.vin} -- ${vehicle.make} ${vehicle.model}`,
              value: vehicle.vin,
            };
      ...
      .prompt([
        {
          ...
          choices: [
            ...
            'Turn left',
            'Reverse',
            vehicle instanceof Truck ? 'Tow' : null,
            vehicle instanceof Motorbike ? 'Wheelie' : null,
